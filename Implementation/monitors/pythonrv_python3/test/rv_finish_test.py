...
class TestSuccessAndFailure(unittest.TestCase):
    def test_success_removes_spec(self):
        ...
        with self.assertRaises(ValueError) as e:
            a.m()
        self.assertEqual(e.exception.message, "first time only")
    ...
    def test_remove_and_next_still_called(self):
        ...
        self.assertEqual(len(M.m._prv.rv.specs), 1)
        self.assertEqual(len(M.n._prv.rv.specs), 1)
        ...
        with self.assertRaises(AssertionError) as e:
            a.m()
        self.assertEqual(e.exception.message, "spike")
        ...
        with self.assertRaises(AssertionError) as e:
            a.n()
        self.assertEqual(e.exception.message, "hacket")


        self.assertEqual(len(M.m._prv.rv.specs), 0)
        self.assertEqual(len(M.n._prv.rv.specs), 0)
    ...
    def test_complex_remove(self):
        ...
        a.calls = ">"
        a.m()
        self.assertEqual(">12", a.calls)
        a.m()
        self.assertEqual(">1212", a.calls)
        a.n()
        self.assertEqual(">121212", a.calls)

        a.m()
        self.assertEqual(">1212122", a.calls)
        a.n()
        self.assertEqual(">12121222", a.calls)
